...
var GrinderyLoginContext = /*#__PURE__*/createContext(defaultContext);
/**
...
var GrinderyLoginProvider = function GrinderyLoginProvider(_ref) {
  ...
  var identifyUser = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
...
var useGrinderyLogin = function useGrinderyLogin() {
  return useContext(GrinderyLoginContext);
};

export default GrinderyLoginProvider;
export { GrinderyLoginContext, GrinderyLoginProvider, LOGIN_URL, useGrinderyLogin };
//# sourceMappingURL=use-grindery-login.esm.js.map
